...
#Plot 3, 3 outliers
#point 4341 has a lot of leaverage, as does 3873 and 90.
...
#it seems as though the data has non constant variance and needs to be stabalized via a transformation and it has high influence. The leaverage also seems weird but not sure what to do about that.  
...
#there still appears to be an outlier in 86 and 87, based on the plots and cooke 
...
```{r}
#Visualize the affect of the influence point
...
# the highest Radj2 reveal the same model as in the stepwise comparison as price = year + presenting price + fuel type + seller + number of owners
